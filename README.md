...
* tcs-template-java-assembly - an assembly that talks to the tcs-template-java HCD
* tcs-template-java-hcd - an HCD that talks to the tcs-template-java hardware
* tcs-template-java-deploy - for starting/deploying HCD's and Assembly's
